...
const Register = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      <Image
        source={require("./img/start.jpg")}
        style={{ width: 300, height: 150, marginBottom: 20, zIndex: -1 }}
      />
      ...
      <TextInput
        ...
        style={{ marginBottom: 10, borderWidth: 1, padding: 7, width: 290, borderRadius: 10, borderColor: 'green' }}
      />
      <TextInput
        placeholder="Пароль"
        value={password}
